...
\vspace{3cm}
\title{Audio Filter}
\author{EE23BTECH11213 - MUTHYALA NIKHITHA SRI $^{*}$% <-this % stops a space
}
\maketitle
\newpage
\bigskip
...
\begin{lstlisting}
$https://github.com/NikhithaSri4/Audio-Filter/tree/main/Audio-Filter/codes/nikhitha.wav
\end{lstlisting}
...
\item
The output of the python script in Problem \ref{prob:output} is the audio file nikhitha-filtered.wav. Play the file in the spectrogram in Problem \ref{prob:spectrogram}. What do you observe?
\\
...
\begin{lstlisting}
https://github.com/NikhithaSri4/Audio-Filter/tree/main/Audio-Filter/codes/code1.c
\end{lstlisting} 
The following code plots \eqref{prob:2.1} and \eqref{prob:2.2}
\begin{lstlisting}
https://github.com/NikhithaSri4/Audio-Filter/tree/main/Audio-Filter/codes/code1.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/NikhithaSri4/Audio-Filter/tree/main/Audio-Filter/codes/code2.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/NikhithaSri4/Audio-Filter/tree/main/Audio-Filter/codes/code3.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/NikhithaSri4/Audio-Filter/tree/main/Audio-Filter/codes/code4.py
\end{lstlisting}
\begin{figure}[!ht]
\centering
...
%
\begin{lstlisting}
https://github.com/NikhithaSri4/Audio-Filter/tree/main/Audio-Filter/codes/code5.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/NikhithaSri4/Audio-Filter/tree/main/Audio-Filter/codes/code6.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/NikhithaSri4/Audio-Filter/tree/main/Audio-Filter/codes/code7.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/NikhithaSri4/Audio-Filter/tree/main/Audio-Filter/codes/code8.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/NikhithaSri4/Audio-Filter/tree/main/Audio-Filter/codes/code9.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{align}
	&y(n) - \brak{-3.8289861}y(n - 1) + \brak{2.20908011}y(n - 2) \nonumber \\
...
\begin{lstlisting}
https://github.com/NikhithaSri4/Audio-Filter/tree/main/Audio-Filter/codes/code10.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/NikhithaSri4/Audio-Filter/tree/main/Audio-Filter/codes/code11.py
\end{lstlisting}
\begin{figure}[H]
\centering
